                ...
                <div class="row mt-3">
                    <div class="col-md-8">
                        <div class="form-group">
                            <input name="title" id="title" class="form-control" placeholder="请输入标题" value="${result.title}">
                        </div>
                    </div>

                    <div class="col-md-4">
                        <button id="submit_btn" class="btn btn-primary" >修改文章</button>
                    </div>
                </div>
                <div class="row mt-3">
                    <div class="col-md-8">
                        <div class="form-group">
                            <input id="outline" name="outline" class="form-control" placeholder="请输入文章简介" value="${result.outline}">
                        </div>
                    </div>
                </div>
                <div class="row mt-3">
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <c:if test="${result.theme==1}">
                                <label>
                                    <input type="radio" name="theme" id="theme1" value="0" class="a-radio" >
                                    <span class="b-radio"></span>主题1
                                </label>
                                <label>
                                    <input type="radio" name="theme" id="theme2" value="1" class="a-radio" checked>
                                    <span class="b-radio"></span>主题2
                                </label>
                    ...
                    <div class="col-md-8">
                        <div class="form-group">
                            <div id="preview">
                                ...
                                <img id="imghead" border="0" src="${result.articlePhoto.url}" width="50" height="50" >
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        $.ajax({
            url:"/blog/edit/mdStr?id=${param.id}",
            type:"get",
            success:function(md){
